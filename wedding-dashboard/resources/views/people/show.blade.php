...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">View Person</h1>
    <div>
        <a href="{{ route('people.edit', $record) }}" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm">
            <i class="fas fa-edit fa-sm text-white-50"></i> Edit
        </a>
        <a href="{{ route('people.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm">
