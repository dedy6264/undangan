...
@section('title', 'Create Order - Step 7: Payment Method')

@section('wizard-content')
<form method="POST" action="{{ route('create-order.process-step7') }}">
    @csrf
        ...
        <div class="col-12">
            ...
            @else
                                ...
                                <div class="card-footer">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="payment_method_id" 
                                               id="payment_method_{{ $paymentMethod->id }}" value="{{ $paymentMethod->id }}"
                                               {{ $loop->first ? 'checked' : '' }}>
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('create-order.step6') }}" class="btn btn-secondary">Back</a>
                </div>
            @endif
        </div>
    </div>
